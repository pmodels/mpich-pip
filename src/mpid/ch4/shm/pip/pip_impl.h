...
MPL_STATIC_INLINE_PREFIX int MPIDI_PIP_Compl_task_safe_enqueue(MPIDI_PIP_task_queue_t * task_queue,
        MPIDI_PIP_task_t * task)
{
	// int err = 0;
...
MPL_STATIC_INLINE_PREFIX int MPIDI_PIP_Compl_task_safe_dequeue(MPIDI_PIP_task_queue_t * task_queue,
        MPIDI_PIP_task_t ** task)
{
	int mpi_errno = MPI_SUCCESS, err;
