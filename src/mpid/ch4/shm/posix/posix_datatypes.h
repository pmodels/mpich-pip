...
#define MPIDI_POSIX_CELL_LEN_32KB  (32*1024)
...
#define MPIDI_POSIX_CELL_PAYLOAD_LEN_32KB (MPIDI_POSIX_CELL_LEN_32KB - MPIDI_POSIX_CACHE_LINE_LEN + MPIDI_POSIX_MPICH_HEAD_LEN)
...
#define MPIDI_POSIX_DATA_LEN_32KB (MPIDI_POSIX_CELL_PAYLOAD_LEN_32KB - MPIDI_POSIX_MPICH_HEAD_LEN)
